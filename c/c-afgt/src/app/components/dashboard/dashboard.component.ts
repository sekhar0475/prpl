  ...
  onSelectBlock(value: string) {
    ...
    if (this.selectedValue === 'PENDING') {
     ...
     // this.dataSource.paginator.firstPage();
      ...
      this.router.navigate(['/asso_air-contract/create-associate-contract',{openDialog : true}], { skipLocationChange: true })
      ...
      this.router.navigate(['/asso_air-contract/apilog'], { skipLocationChange: true })
    }else {
