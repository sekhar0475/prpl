  ...
  onSelectBlock(value: string) {
    ...
    if (this.selectedValue === 'PENDING') {
     ...
     // this.dataSource.paginator.firstPage();
      ...
      this.router.navigate(['/asso_cargo-contract/create-associate-contract',{openDialog : true}], { skipLocationChange: true })
    }
      ...
      this.router.navigate(['/asso_cargo-contract/apilog'], { skipLocationChange: true })
    } else {
