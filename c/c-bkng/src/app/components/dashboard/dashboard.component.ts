  ...
  onSelectBlock(value: string) {
    ...
    if (this.selectedValue === 'PENDING') {
     ...
     // this.dataSource.paginator.firstPage();
      ...
      this.router.navigate(['/asso_booking-contract/create-associate-contract',{openDialog : true}], { skipLocationChange: true })
      ...
      this.router.navigate(['/asso_booking-contract/apilog'], { skipLocationChange: true })
    }else {
